					...
					projects: [
						{
							...
							responsibility: [
								'Ingested data into Azure Data Lake using ADF pipelines.',
								'Performed data transformation using PySpark in Databricks.',
								'Created curated datasets for analytics and reporting dashboards.',
								'Improved data processing performance by 25% through Spark optimization.',
							],
					...
					projects: [
						{
							...
							description: '',
							responsibility: [
								'Designed and developed scalable data pipelines using PySpark for processing structured and unstructured data.',
								'Built and maintained ADF pipelines for end-to-end data orchestration (datasets, triggers, monitoring).',
								'Data migration projects from on-premise systems to Azure Cloud environments.',
								'Developed and optimized Databricks notebooks for ETL transformations and validation.',
								'Created and maintained technical documentation for data workflows.',
							],
						...
						},
						{
							...
							responsibility: [
								...
								'Optimized Spark workloads by 25%.',
							],
						...
						},
						{
							...
							description: 'Personal Project - Built RAG solution with generated embeddings and semantic search.',
							responsibility: [
								'Generated embeddings and semantic search.',
								'Automated deployment using Azure DevOps CI/CD.',
							],
					...
					projects: [
						{
							...
							responsibility: [
								'Built foundational knowledge in cloud-based data systems and ETL workflows.',
							],
